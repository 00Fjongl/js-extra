...
isFinite(c)&&(console.log('c is infinite'),isNaN(c)?b:a)();
```
The same can also be done with bracket notation (e.g. `array1&&array1[delete array1,4]`), although some cases may interfere with its return value. Beyond function returns and conditionals, this is applicable to default parameters, passing arguments, and creating space to efficiently reassign variables. Unused arguments in functions also serve as space.
# Major Redesigns
