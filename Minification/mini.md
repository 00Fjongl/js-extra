### Standard JavaScript constraints for shortening properties or objects:
...
```
Every additional variable in it will save 2 bytes each, regardless of string length.
