...
```
Every additional variable included will save 2 bytes each, regardless of string length. This is important because additional **properties now follow the chart for Variable Reassignment.**
